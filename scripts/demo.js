...
//             terra.visible = value;
//         } );
//         buildingFolder.add( effectController, 'showSimplified' ).onChange( function ( value ) {
...
//             results.forEach(
//                 function (item, index) {
//                     if ( index == currentMonth-1 ) { item.visible = value; }
...
//         resultFolder.add( months, months[0], 1, 12, 1 ).name('month').onChange( function ( value ) {
...
//             results.forEach(
//                 function (item, index) {
//                     if ( index == value -1 && effectController.showResult == true ) { item.visible = true; }
//                     else { item.visible = false; };
//                 }
//             );
