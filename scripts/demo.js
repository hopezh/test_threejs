...
function init() {
    ...
    loader.load(
        "../assets/3d_models/terra_3dm/terra_simplified.3dm",
        function (object) {
    ...
    // load sun path
    loader.load(
        "../assets/3d_models/terra_3dm/terra_sunpath.3dm",
        function (object) {
            object.traverse(function (child) {
                if (child instanceof THREE.Line) {
                    child.material = line_mat;
    ...
    loader.load(
        "../assets/3d_models/terra_3dm/terra_num.3dm",
        function (object) {
            object.traverse(function (child) {
                if (child instanceof THREE.Mesh) {
                    child.material = meshMaterial_c;
    ...
    for (var i = 1; i <= 12; i++) {
        loader.load(
            "../assets/3d_models/terra_3dm/terra_sunhour_" +
                i.toString() +
                ".3dm",
            function (object) {
                object.traverse(function (child) {
    ...
    new MTLLoader()
        .setPath("../assets/3d_models/terra_obj/")
...
function initGUI(meshMaterial_b) {
    ...
    buildingFolder
        .add(effectController, "showTerra")
